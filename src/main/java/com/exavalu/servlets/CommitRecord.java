...
public class CommitRecord extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if (incomeAmountStr != null && !incomeAmountStr.trim().isEmpty()) {
	        ...
	        operationSuccess = RecordsService.HandleIncome(userEmail, currencyName, accountId, amount, propertyValues);
	        ...
	        operationSuccess = RecordsService.HandleExpense(userEmail, currencyName, accountId, amount, propertyValues);
