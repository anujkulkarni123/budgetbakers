...
// Debug to confirm they are received
System.out.println("Accounts: " + accountsRecord);
System.out.println("Account Types: " + accountTypeListRecord);
System.out.println("Currencies: " + currencyListRecord);
System.out.println("Account Type Map: " + accountTypeMapRecord);
System.out.println("Currency Map: " + currencyMapRecord);
%>
<div id="recordPopup"
	...
	<div
		style="background-color: #fefefe; margin: auto; padding: 20px; border: 1px solid #888; width: 60%; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
		<div
		...
		<div style="display: flex; height: 80%;">
			<div
				style="width: 60%; padding-right: 20px; border-right: 1px solid #ccc;">
				...
				<div id="expense" class="content" style="display: none;">
					<label for="expenseAccount">Account:</label> <select
						...
						<option value="<%=account.getAccountId()%>">
							<%=account.getName()%> -
							<%=accountTypeMapRecord.get(account.getAccountTypeId())%> - Balance:
						...
						%>
					</select> </select> <label for="expenseAmount">Amount:</label> <input type="number"
				...
				<div id="income" class="content" style="display: none;">
					<label for="incomeAccount">Account:</label> <select
						...
						for="incomeCurrency">Currency:</label> <select id="incomeCurrency"
						name="incomeCurrency">
						<%
						for (Currency currency : currencyListRecord) {
						%>
